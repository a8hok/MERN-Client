...
const [testiData, setTestiData] = useState([
    {
        message: `I've been using this website for a few months now and it has been a game-changer for me. 
    ...
    {
        message: `I was looking for a platform that could provide me 
    ...
    {
        message: `As a university administrator, I was looking for a way to 
...
useEffect(() => {
  ...
  return (
    <div ref={elementRef1} className="testimonials_banner-container">
        {testiData.map((i, index) => {
            return (
                <div key={index} className={`${visible1 ? `testimonials_banner_${index+1}` : `testimonials_banner_alternate`}`}>
