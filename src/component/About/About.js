      ...
      <div className="all-about-container">
        ...
        <div className="about-right-container">
          <div className="about-container">
            <span>
                <h1 className="learnPlus-heading">LPP Learning Technology Solutions</h1>
                <h1 className="multicolortext">LearnPlusPlus.com</h1>
                <h1 className="learnPlus-coverLetter">THE COMPREHENSIVE DIGITAL EDUCATIONAL PLATFORM</h1>
            </span>
              <p>
